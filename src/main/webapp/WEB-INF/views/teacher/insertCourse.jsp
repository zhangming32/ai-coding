...
<body>
    <div class="container">
        ...
        <form id="courseForm">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="classNum" name="classNum" required>
            </div>
            <div class="form-group">
                <label>学院限制</label>
                <c:forEach items="${insList}" var="ins">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="insIds" value="${ins.insId}"> ${ins.insName}
                        </label>
                    </div>
                </c:forEach>
            </div>
    ...
    <script>
        function submitForm() {
            ...
            window.location.href = 'insertCourseSuccess?content=' + content + '&page=1';
        }
    </script>
</body>
</html>